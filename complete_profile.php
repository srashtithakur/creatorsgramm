                            ...
                            <div class="mt-5">
                                <form name="contactForm" id='contact_form' class="form-border" method="post" action=''>
                                    ...
                                    <div class="field-set">
                                        ...
                                        <input type='text' name='email' id='username' class="form-control" placeholder="Samsmith67">
                                    </div>

                                    <div class="field-set">
                                        <label for="bio">Bio</label>
                                        <input type='text' name='bio' id='bio' class="form-control " placeholder="Lorem ipsum dolor sit">
                                    </div>
